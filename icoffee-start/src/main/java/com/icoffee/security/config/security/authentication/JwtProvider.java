...
public class JwtProvider {
     ...
     * 过期时间
     */
    private final Long expires = 30 * 60 * 1000L;
    /**
     * 签发者
     */
    private final String issuer = "icoffee-admin";
    /**
     * 签发给谁
     */
    private final String audience = "icoffee-vue";
    /**
     * token秘钥
     */
     ...
     * @return
     */
    public String createToken(String username, List<PermissionDto> permissionDtoList) {
        try {
     ...
     * @return
     */
    public DecodedJWT verifyToken(String token, String secretKey) {
     ...
     * @return
     */
    public Header decodeTokenHeader(String token) {
     ...
     * @return
     */
    public Payload decodeTokenPayload(String token) {
        Assert.requireNonEmpty(token, "token不能为空！");
        String[] parts = {};
        try {
            parts = StringUtils.split(token, ".");
